...
**1511 passed, 6 skipped** on HOOMD-blue 7.1.0, plus **42 sealed
...
| **1511 tests** | 6 skipped, 85-165 s on CI with the engine → [above](#brownian-dynamics-agent) |
...
| Tests | **1511 pass**, 6 skipped (wall time not quoted — see the badge note) |
