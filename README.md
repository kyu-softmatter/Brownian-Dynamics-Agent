...
| **Knowledge base** | 54 wiki pages — 12 system cards · 30 findings · 5 concepts — plus 43 paper and 2 book distillations and 166 tool-written entries |
...
```text
  ...
  |                                                                    |
  |  entries/           166 tool-written entries. 62 of them are       |
  |                     `tooling` -- which is the honest measure of    |
  |                     how much of this is fighting instruments       |
  |                     rather than physics.                           |
  |                                                                    |
  |  runs/**/record.json   247 post-mortems. A run is not finished     |
...
| Knowledge | 54 wiki pages · 43 paper + 2 book distillations · 166 entries |
| Agent layer | 6 skills · 9 model-tiered subagents · 4 rules |
