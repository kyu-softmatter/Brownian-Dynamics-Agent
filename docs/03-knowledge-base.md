...
| Size | 52 wiki pages · 43 paper + 2 book distillations | 160 entries |
...
| **`findings/`** | 28 | Q→A, and **dead-ends** | summary · basis · scope/limits · references |
...
160 entries, by origin. The distribution is itself a finding:
